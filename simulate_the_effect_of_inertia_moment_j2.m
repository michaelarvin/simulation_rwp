% script: simulate_e% script: simulate_effect_of_the_inertia_moment_of_wheel
...
% Calculate A and B for state space model
...
% Run response time to initial condition
t = 0:0.1:10;
...
ffect_of_the_inertia_moment_of_wheel
% goal: Shows the effect of the inertia moment of wheel, J2
% const parameter = Vm = 20 !
% used Simulink file: 'pendulum_iwp_cube_v2'
%
